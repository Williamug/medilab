<section>
    @if ($lab_service_categories->isNotEmpty())
        <div>
                                    ...
                                    @foreach ($lab_service_categories as $lab_service_category)
                                        <tr>
                                            <td class="px-4 py-4 text-sm font-medium whitespace-nowrap">
                                                <div>
                                                    {{ $lab_service_category->category_name }}
                                                </div>
                                            </td>
                                            <td class="px-4 py-4 text-sm font-medium whitespace-nowrap">
                                                <div>
                                                    {{ $lab_service_category->created_at->format('D, d M Y | H:i:s') }}
                                                </div>
                                            </td>
                                            ...
                                            <td class="px-6 py-3 text-center">
                                                <div class="flex justify-center item-center">
                                                    <!-- edit -->
                                                    <a wire:click.prevent="openEditModal({{ $lab_service_category->id }})"
                                                        href="#"
                                                    ...
                                                    <!-- delete -->
                                                    <button
                                                        wire:click.prevent="openDeleteModal({{ $lab_service_category->id }})"
                                                        type="button"
    ...
    @endif
    @include('partials.lab-service-category-modal')
</section>
