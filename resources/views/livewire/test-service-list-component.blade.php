<div>
                                    ...
                                    <div class="flex">
                                        <div class="flex">
                                            ...
                                            @can('edit test service')
                                                <a wire:click.prevent="openEditModal({{ $test_service->id }})"
                                        ...
                                        @can('delete test service')
                                            <div>
                                                <button wire:click.prevent="openDeleteModal({{ $test_service->id }})"
                                                    title="Delete"
    ...
    @include('partials.test-service-modal')
</div>
