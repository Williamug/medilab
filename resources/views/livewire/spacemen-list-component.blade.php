<div>
    <div>
        <div class="flex flex-col my-2 sm:flex-row">
            ...
            <div>
                ...
                <x-app.a href="{{ route('deleted-spacemen.index') }}"
                    ...
                    <tbody>
                        @foreach ($spacemens as $spacemen)
                            <tr>
                                ...
                                <td class="px-5 py-5 text-sm bg-white border-b border-gray-200">
                                    <p class="text-gray-900 whitespace-no-wrap">
                                        {{ $spacemen->created_at->format('d/m/Y') }}
                                    </p>
                                </td>
                                ...
                                @can('view outcome')
                                    <td class="px-5 py-5 text-sm bg-white border-b border-gray-200">
                                        ...
                                        <div class="flex">
                                            <div class="flex">
                                                {{-- <a href="{{ route('spacemens.show', $spacemen) }}"
                                                ...
                                                <x-app.a wire:click.prevent="openEditModal({{ $spacemen->id }})"
                                                    href="#" class="px-2 bg-green-700 hover:bg-green-900"
                                                    title="Edit">
                                                    <svg xmlns="http://www.w3.org/2000/svg" fill="currentColor"
                                                        class="w-6 h-6 mr-3 text-white bi bi-pencil-square hover:text-white"
                                                        viewBox="0 0 16 16">
                                                        <path
                                            ...
                                            <div>
                                                <button wire:click.prevent="openDeleteModal({{ $spacemen->id }})"
                                                    title="Delete"
                                                    class="px-2 py-1 ml-2 text-white uppercase bg-red-700 rounded hover:bg-red-900">
                                                    <svg xmlns="http://www.w3.org/2000/svg" fill="currentColor"
                                                        class="w-6 h-6 mr-3 text-white bi bi-trash hover:text-white"
                                                        viewBox="0 0 16 16">
                                                        <path
    ...
    @include('partials.spacemen-modal')
</div>
