                    ...
                    <thead>
                        <tr>
                            <th
                                ...
                                <a wire:click.prevent="sortBy('result')" role="button" href="#" class="flex">
                                    Result Option
                                    @include('partials.sort_icons', ['field' => 'result'])
                                </a>
                            </th>

                            <th
                                class="px-5 py-3 text-xs font-semibold tracking-wider text-left text-gray-600 uppercase bg-gray-100 border-b-2 border-gray-200">
                                <a wire:click.prevent="sortBy('code')" role="button" href="#" class="flex">
                                    Code
                                    ...
                                    <td class="px-5 py-5 text-sm bg-white border-b border-gray-200">
                                        ...
                                        <div class="flex">
                                            <div class="flex">
                                                ...
                                                <x-app.a wire:click.prevent="openEditModal({{ $result_option->id }})"
                                                    href="#" class="px-2 bg-green-700 hover:bg-green-900"
                                                    title="Edit">
                                                    <svg xmlns="http://www.w3.org/2000/svg" fill="currentColor"
                                                        class="w-4 h-4 mr-3 text-white bi bi-pencil-square hover:text-white"
                                                        viewBox="0 0 16 16">
                                                        <path
